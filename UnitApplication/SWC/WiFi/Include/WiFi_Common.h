...
/* Server defines */
#define PICO_W_AP_TCP_SERVER_ADDRESS  "192.168.4.1"    //IP address of the Pico W which acts as the Access Point (AP) and TCP server
...
#define TCP_PORT                    80               //HTTP port of Pico W AP TCP server
