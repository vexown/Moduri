...
/* ############################################################################################################################ */
/* TEMPORARY SETUP:                                                                                                            */
/* Replace this code in the picow_access_point.c example in the pico-examples repo and build it there. I will put the built     */
/* binary in the output folder so if you just want to flash it then go ahead but for any changes to code do it in pico-examples */
/* ############################################################################################################################ */
/* ############################################################################################################################ */
/* ############################################################################################################################ */
/* ############################################################################################################################ */
...
static void setupHardware(void)
{
    ...
    isOpen = false; // establish the initial state of the lid
