...
SOURCE_FILE="./output/moduri_bank_B.bin" # the app binary is in this location by default after build
DEST_FILE="/var/www/html/firmware.bin" # the location where the apache2 server serves files
